...
(function() {
  ...
  AFMFont = (function() {
    ...
    AFMFont.prototype.parse = function() {
      var a, j, key, len, line, match, name, ref, results, section, value;
      section = '';
        ...
        switch (section) {
          case 'FontMetrics':
            ...
            if (a = this.attributes[key]) {
              ...
              results.push(a.push(value));
            } else {
              results.push(this.attributes[key] = value);
            }
            break;
          case 'CharMetrics':
            if (!/^CH?\s/.test(line)) {
            ...
            results.push(this.glyphWidths[name] = +line.match(/\bWX\s+(\d+)\s*;/)[1]);
            break;
          default:
            results.push(void 0);
        }
