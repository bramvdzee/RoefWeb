...
(function() {
  ...
  PDFFont = (function() {
    ...
    function PDFFont(document, filename, family, id) {
      ...
      this.family = family;
      this.id = id;
      if (ref1 = this.filename, indexOf.call(this._standardFonts, ref1) >= 0) {
        this.embedStandard();
    ...
    PDFFont.prototype.use = function(characters) {
      var ref1;
      return (ref1 = this.subset) != null ? ref1.use(characters) : void 0;
    };
    ...
    PDFFont.prototype.encode = function(text) {
      var ref1;
      return ((ref1 = this.subset) != null ? ref1.encodeText(text) : void 0) || text;
    };

    PDFFont.prototype.registerTTF = function() {
      var e, gid, hi, i, low, raw, ref1;
      ...
      this.isSerif = (ref1 = this.familyClass) === 1 || ref1 === 2 || ref1 === 3 || ref1 === 4 || ref1 === 5 || ref1 === 7;
      ...
      this.charWidths = (function() {
        var ref2, results;
        ref2 = this.cmap.codeMap;
        results = [];
        for (i in ref2) {
          gid = ref2[i];
          if (i >= 32) {
            results.push(Math.round(this.hmtx.widths[gid] * this.scaleFactor));
          }
        }
        return results;
      }).call(this);
    ...
    PDFFont.prototype.embedTTF = function(fn) {
      ...
      return zlib.deflate(data, (function(_this) {
        return function(err, compressedData) {
          ...
          charWidths = (function() {
            var ref1, results;
            ref1 = this.subset.cmap;
            results = [];
            for (code in ref1) {
              glyph = ref1[code];
              results.push(Math.round(this.ttf.hmtx.forGlyph(glyph).advance * this.scaleFactor));
            }
            return results;
          }).call(_this);
    ...
    PDFFont.prototype.widthOfString = function(string, size) {
      var charCode, i, j, ref1, scale, width;
      string = '' + string;
      width = 0;
      for (i = j = 0, ref1 = string.length; 0 <= ref1 ? j < ref1 : j > ref1; i = 0 <= ref1 ? ++j : --j) {
