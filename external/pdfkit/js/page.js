      ...
      Object.defineProperties(this, {
        fonts: {
          get: (function(_this) {
            return function() {
              var base;
              return (base = _this.resources)['Font'] != null ? base['Font'] : base['Font'] = {};
            };
          })(this)
        },
        xobjects: {
          get: (function(_this) {
            return function() {
              var base;
              return (base = _this.resources)['XObject'] != null ? base['XObject'] : base['XObject'] = {};
            };
          })(this)
        },
        ext_gstates: {
          get: (function(_this) {
            return function() {
              var base;
              return (base = _this.resources)['ExtGState'] != null ? base['ExtGState'] : base['ExtGState'] = {};
            };
          })(this)
        },
        patterns: {
          get: (function(_this) {
            return function() {
              var base;
              return (base = _this.resources)['Pattern'] != null ? base['Pattern'] : base['Pattern'] = {};
            };
          })(this)
        },
        annotations: {
